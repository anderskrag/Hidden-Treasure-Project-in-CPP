...
The filename argument gives a path to a text file that gives the game instance it's initial layout.

## How the game is ran
To start the game the member function .run() is used. This function creats a new window and starts a game.
